...
public class CardItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if(!Screen.hasShiftDown()) {
            tooltip.add((Component) new TranslatableContents("tooltip.maidensmerrymaking.easter_card_shift"));
        } else {
            tooltip.add((Component) new TranslatableContents("tooltip.maidensmerrymaking.easter_card"));
        }
